[![pipeline status](https://github.com/viniciusmattosrj/php-ajax/badges/releaseCandidate/pipeline.svg)](https://github.com/viniciusmattosrj/php-ajax/commits/releaseCandidate)
